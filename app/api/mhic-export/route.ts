...
// Allow up to 60s on Vercel Pro; adjust down if on hobby plan
export const maxDuration = 60;

// Representative Maryland zip codes covering all 23 counties + Baltimore City
const MD_ZIPS = [
  // Baltimore City
...
export async function GET() {
  try {
    ...
    // Query zips in small parallel batches to stay within timeout
    const BATCH = 5;
